...
def p2(lines):
    ...
    return min(size_match)


def day7(input_file="solutions/Day7/sample"):
    print(f"The sum of their total sizes is: {p1(get_input(input_file=input_file))}")
    print(f"Smallest matching dir size: {p2(get_input(input_file=input_file))}")
