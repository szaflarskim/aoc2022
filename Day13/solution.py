...
def p1(input_file="Day13/sample"):
...
def p2(input_file="Day13/sample"):
...
def day13(input_file="Day13/sample"):
    p1(input_file)
    p2(input_file)


def test_already_sorted():
    packet_pairs = get_packet_pairs("Day13/sample")
    already_right_order = get_indices_in_right_order(packet_pairs)
...
def test_divider_indices():
    packets = get_packets("Day13/sample")
